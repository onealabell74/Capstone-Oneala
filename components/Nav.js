    ...
    <i class="fas fa-bars"></i>
      <ul class="hidden--mobilenav-links">
        ...
        <li><a href="Contact" data-navigo>Contact</a></li>
         <li class="dropdown"><a href="javascript:void(0)" class="dropbtn">Dialysis Treatments</a>
        ...
        <li class="dropdown"><a href="javascript:void(0)" class="dropbtn"> Dialysis Access</a>
        <div class="dropdown-content">
